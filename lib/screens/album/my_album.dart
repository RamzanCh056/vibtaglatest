...
import 'package:vibetag/screens/album/album_detail_screen.dart';
...
class _MyAlbumState extends State<MyAlbum> {
  ...
  getAlbum() async {
    var headers = {
      'Cookie':
          'DO-LB="MTAuMTA2LjAuNDo0NDM="; PHPSESSID=vjrgt9vu26u6i7keuqt66au4bf; _us=1686134568; access=1; ad-con=%7B%26quot%3Bdate%26quot%3B%3A%26quot%3B2023-06-06%26quot%3B%2C%26quot%3Bads%26quot%3B%3A%5B%5D%7D; mode=day; post_privacy=0; src=1'
    };
  ...
  deleteAlbum() async {
    ...
    var headers = {
      'Cookie':
          'DO-LB="MTAuMTA2LjAuNDo0NDM="; PHPSESSID=20iletdp527n65ucqqc69og19m; _us=1686219293; access=1; ad-con=%7B%26quot%3Bdate%26quot%3B%3A%26quot%3B2023-06-07%26quot%3B%2C%26quot%3Bads%26quot%3B%3A%5B%5D%7D; mode=day; post_privacy=0; src=1'
    };
    var request = http.MultipartRequest(
        'POST', Uri.parse('https://vibetag.com/app_api.php'));
    request.fields.addAll({
