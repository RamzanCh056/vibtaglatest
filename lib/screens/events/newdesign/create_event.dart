...
class CreateEvetns extends StatefulWidget {
  CreateEvetns({super.key});


  @override
  State<CreateEvetns> createState() => _CreateEvetnsState();
}

class _CreateEvetnsState extends State<CreateEvetns> {
  ...
  createEvent()async{
    ...
    request.files.add(await http.MultipartFile.fromPath('event-cover', imageFile!.path));
...
//   });
//   var headers = {
//     'Cookie': 'DO-LB="MTAuMTA2LjAuMzo0NDM="; PHPSESSID=hhp6nes5sss6b4l112fctq2lcl; _us=1682695473; access=1; ad-con=%7B%26quot%3Bdate%26quot%3B%3A%26quot%3B2023-04-27%26quot%3B%2C%26quot%3Bads%26quot%3B%3A%5B%5D%7D; mode=day; post_privacy=0; src=1'
//   };
//   var request = http.MultipartRequest('POST', Uri.parse('https://vibetag.com/app_api.php'));
//   request.fields.addAll({
//     'type': 'create_event',
...
//     'event-locat': 'Islamabad, Pakistan',
//     'event-description': 'this is desc',
//     'event-start-date': '2022-12-09',
//     'event-start-time': '12:00',
//     'event-end-date': '2022-12-10',
...
//   if (response.statusCode == 200) {
//   print(await response.stream.bytesToString());
//   Fluttertoast.showToast(msg: "succefully");
//   setState(() {
//     isLoading = false;
//   });
//   }
