...
class _CreateBusinessPageState extends State<CreateBusinessPage> {
  ...
  createPage() async {
    ...
    var headers = {
      'Cookie':
          'PHPSESSID=65aa2c9fc4687e42480ad9f915558455; _us=1669384827; access=1; ad-con=%7B%26quot%3Bdate%26quot%3B%3A%26quot%3B2022-11-24%26quot%3B%2C%26quot%3Bads%26quot%3B%3A%5B%5D%7D; mode=day; src=1'
    };
    ...
    if (response.statusCode == 200) {
      ...
      if (body['errors'] != null) {
        ...
        Navigator.push(context,
            MaterialPageRoute(builder: (context) => MyPageHomeScreen()));
  ...
  getPageCatagory() async {
    var headers = {
      'Cookie':
          'PHPSESSID=65aa2c9fc4687e42480ad9f915558455; _us=1669384785; access=1; ad-con=%7B%26quot%3Bdate%26quot%3B%3A%26quot%3B2022-11-24%26quot%3B%2C%26quot%3Bads%26quot%3B%3A%5B%5D%7D; mode=day; src=1'
    };
    var request = http.MultipartRequest(
        'POST', Uri.parse('https://vibetag.com/app_api.php'));
    request.fields.addAll({
