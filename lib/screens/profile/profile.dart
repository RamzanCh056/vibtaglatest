                                          ...
                                          children: [
                                            Container(
                                              ...
                                              child: Column(
                                                children: [
                                                  Text(
                                                    '${getInK(number: widget.user_id != loginUserId ? profileUserDetails['total_reactions'] != '[]' ? int.parse(profileUserDetails['total_reactions'].toString()) : 0 : userDetails.total_reactions)}',
                                                    style: const TextStyle(
                                                      fontSize: 10,
                                                    ),
                                                  ),
                                            ...
                                            Container(
                                              ...
                                              child: Column(
                                                children: [
                                                  Text(
                                                    '${getInK(number: widget.user_id != loginUserId ? profileUserDetails['followers_count'] != null ? int.parse(profileUserDetails['followers_count'].toString()) : 0 : int.parse(userDetails.followers_count))}',
                                                    style: const TextStyle(
                                                      fontSize: 10,
                                                    ),
                                                  ),
                                            ...
                                            Container(
                                              ...
                                              child: Column(
                                                children: [
                                                  Text(
                                                    '${getInK(number: widget.user_id != loginUserId ? profileUserDetails['following_count'] != null ? int.parse(profileUserDetails['following_count'].toString()) : 0 : int.parse(userDetails.following_count))}',
                                                    style: const TextStyle(
                                                      fontSize: 10,
                                                    ),
                                                  ),
                                            ...
                                            Container(
                                              ...
                                              child: Column(
                                                children: [
                                                  Text(
                                                    '${getInK(number: widget.user_id != loginUserId ? profileUserDetails['video_views'] != null ? int.parse(profileUserDetails['video_views'].toString()) : 0 : int.parse(userDetails.video_views))}',
                                                    style: const TextStyle(
                                                      fontSize: 10,
                                                    ),
                                                  ),
                                                                        ...
                                                                        children: [
                                                                          Text(
                                                                            widget.user_id != loginUserId
                                                                                ...
                                                                                : getInK(
                                                                                    number: int.parse(userDetails.followers_count),
                                                                                  ),
                                                                            style:
                                                                                TextStyle(
                                                                              color: blackPrimary,
                                                                        ...
                                                                        children: [
                                                                          Text(
                                                                            widget.user_id != loginUserId
                                                                                ...
                                                                                : getInK(
                                                                                    number: int.parse(userDetails.following_count),
                                                                                  ),
                                                                            style:
                                                                                TextStyle(
                                                                              color: blackPrimary,
