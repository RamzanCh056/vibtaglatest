...
class SingleUserShow extends StatefulWidget {
  const SingleUserShow({Key? key}) : super(key: key);

  @override
  State<SingleUserShow> createState() => _SingleUserShowState();
}

class _SingleUserShowState extends State<SingleUserShow> {
                      ...
                      endActionPane: ActionPane(
                        ...
                        children: [
                          SlidableAction(
                            ...
                            backgroundColor: const Color(0xFFFD4F87),
