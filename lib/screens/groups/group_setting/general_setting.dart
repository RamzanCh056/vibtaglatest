...
class GeneralSettingGroup extends StatefulWidget {
  const GeneralSettingGroup({Key? key}) : super(key: key);

  @override
  State<GeneralSettingGroup> createState() => _GeneralSettingGroupState();
}

class _GeneralSettingGroupState extends State<GeneralSettingGroup> {
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                        ...
                        hintStyle: TextStyle(
                            ...
                            color: Color(0xff99A7C7)),
                        hintText:
                            "Street no. 2 Austin Road, nearby\nWin Garden",
                        focusedBorder: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(8),
                            borderSide:
                                const BorderSide(color: Color(0xffC8D1E5))),
                    ...
                    child: Row(
                      children: [
                        ...
                        Switch(
                          ...
                          inactiveThumbColor:
                              Color(0xFFFFFFFF), // Unactive color
