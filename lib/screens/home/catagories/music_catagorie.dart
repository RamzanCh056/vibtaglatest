...
class MusicCatagroiers extends StatefulWidget {

  const MusicCatagroiers({Key? key}) : super(key: key);

  @override
  State<MusicCatagroiers> createState() => _MusicCatagroiersState();
}

class _MusicCatagroiersState extends State<MusicCatagroiers> {
  var catagorieExpore = [];
  ...
  getListCatagories()async{
    ...
    if (response.statusCode == 200) {
      ...
      catagorieExpore = catagorie['MusicAudio'];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body:  Column(children: [
          ...
          const Text("MusicAudio", style: TextStyle(fontSize: 18),),
          isLoading?
