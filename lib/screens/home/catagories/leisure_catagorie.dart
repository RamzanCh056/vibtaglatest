...
class LeisureCatagroiers extends StatefulWidget {

  const LeisureCatagroiers({Key? key}) : super(key: key);

  @override
  State<LeisureCatagroiers> createState() => _LeisureCatagroiersState();
}

class _LeisureCatagroiersState extends State<LeisureCatagroiers> {
  var catagorieExpore = [];
  ...
  getListCatagories()async{
    ...
    if (response.statusCode == 200) {
      ...
      catagorieExpore = catagorie['Leisure'];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body:  Column(children: [
          ...
          const Text("Leisure", style: TextStyle(fontSize: 18),),
          isLoading?
