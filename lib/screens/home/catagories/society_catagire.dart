...
class SocietyCatagroiers extends StatefulWidget {

  const SocietyCatagroiers({Key? key}) : super(key: key);

  @override
  State<SocietyCatagroiers> createState() => _SocietyCatagroiersState();
}

class _SocietyCatagroiersState extends State<SocietyCatagroiers> {
  var catagorieExpore = [];
  ...
  getListCatagories()async{
    ...
    if (response.statusCode == 200) {
      ...
      catagorieExpore = catagorie['SocietyEnvironment'];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body:  Column(children: [
          ...
          const Text("SocietyEnvironment", style: TextStyle(fontSize: 18),),
          isLoading?
