...
class TvCatagroiers extends StatefulWidget {

  const TvCatagroiers({Key? key}) : super(key: key);

  @override
  State<TvCatagroiers> createState() => _TvCatagroiersState();
}

class _TvCatagroiersState extends State<TvCatagroiers> {
  var catagorieExpore = [];
  ...
  getListCatagories()async{
    ...
    if (response.statusCode == 200) {
      ...
      catagorieExpore = catagorie['TVProgrammes'];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body:  Column(children: [
          ...
          const Text("TVProgrammes", style: TextStyle(fontSize: 18),),
          isLoading?
