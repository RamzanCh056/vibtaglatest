...
class LifeStyleCatagroiers extends StatefulWidget {

  const LifeStyleCatagroiers({Key? key}) : super(key: key);

  @override
  State<LifeStyleCatagroiers> createState() => _LifeStyleCatagroiersState();
}

class _LifeStyleCatagroiersState extends State<LifeStyleCatagroiers> {
  var catagorieExpore = [];
  ...
  getListCatagories()async{
    ...
    if (response.statusCode == 200) {
      ...
      catagorieExpore = catagorie['Lifestyle'];
