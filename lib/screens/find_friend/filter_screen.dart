...
class _FilterScreenState extends State<FilterScreen> {
  ...
  findFriend() async {
    var headers = {
      'Cookie':
          'PHPSESSID=1e5975e69cf73c2e0d9632149980bfc7; _us=1677568950; access=1; ad-con=%7B%26quot%3Bdate%26quot%3B%3A%26quot%3B2023-02-27%26quot%3B%2C%26quot%3Bads%26quot%3B%3A%5B%5D%7D; mode=day; post_privacy=0; src=1'
    };
                        ...
                        child: Column(
                          children: [
                            ...
                            Visibility(
                              ...
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: List.generate(relationshipList.length,
                                    (index) {
                                  return ListTile(
                                    leading: SizedBox(
                                      height: 30,
                                    ...
                                    Row(
                                      children: [
                                        Expanded(
                                          child: InkWell(
                                            onTap: () async {
                                              await AuthMethod().followUser(
                                                  findFriends[index]['user_id']
                                                      .toString());
                                              setState(() {});
                                            },
                                            child: following_data.contains(
                                                    findFriends[index]
                                                            ['user_id']
                                                        .toString())
                                                ? Container(
