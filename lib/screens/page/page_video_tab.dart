...
class PageVideoTab extends StatefulWidget {
  ...
  @override
  State<PageVideoTab> createState() => _PageVideoTabState();
}

class _PageVideoTabState extends State<PageVideoTab> {
                          ...
                          children: [
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        Center(
                                          child: Text(
                                            '${getInK(number: int.parse(profileVideos[0]['post_likes'].toString()))}',
                                            style: TextStyle(
                                              color: orangePrimary,
                                              fontSize: 8,
                                            ),
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        '${getInK(number: int.parse(profileVideos[0]['post_comments'].toString()))}',
                                        style: TextStyle(
                                          fontSize: 10,
                                          color: grayMed,
                                        ),
                            ...
                            Container(
                              ...
                              child: GridView.builder(
                                  itemCount: (profileVideos.length - 2),
                                  gridDelegate:
                                                ...
                                                children: [
                                                  Row(
                                                    ...
                                                    children: [
                                                      ...
                                                      profileVideos[i + 1][
                                                              ...
                                                              null
                                                          ? Text(
                                                              '${getInK(number: int.parse(profileVideos[i + 1]['post_likes'].toString()))}',
                                                              style: TextStyle(
                                                                fontSize: 10,
                                                                color: grayMed,
                                                              ),
                                                  ...
                                                  Row(
                                                    ...
                                                    children: [
                                                      ...
                                                      Text(
                                                        '${getInK(number: int.parse(profileVideos[i + 1]['post_comments'].toString()))}',
                                                        style: TextStyle(
                                                          fontSize: 10,
                                                          color: grayMed,
                                                        ),
