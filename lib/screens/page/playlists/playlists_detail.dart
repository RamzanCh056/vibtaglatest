...
import 'package:vibetag/screens/page/playlists/playlist.dart';
import 'package:vibetag/screens/page/playlists/playlist_item.dart';
import 'package:vibetag/screens/page/playlists/widgets/video_player_landscape_playlist.dart';
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            Container(
                                              ...
                                              child: Html(
                                                data: currentPlaying['postText']
                                                            .toString()
                                                            .length <
                                                        180
                                                    ? currentPlaying['postText']
                                                    : isSeeMore
                                                        ? '${currentPlaying['postText']}  <a href="#"><strong style="color:orange;font-size:13px;"><b>${seeMoreText}</b></strong></a>'
                                                        : '${currentPlaying['postText'].toString().substring(0, 150)}  <a href="#"><strong style="color:orange;font-size:13px;"><b>${seeMoreText}</b></strong></a>',
