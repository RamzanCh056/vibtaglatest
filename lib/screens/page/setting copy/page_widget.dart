          ...
          Column(
            children: [
              ...
              widget.page['likes'].toString() != '0'
                  ? ReusableText(
                      title:
                          '${getInK(number: int.parse(widget.page['likes'].toString()))} Likes',
                      size: 14,
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        ReusableText(
                          title:
                              '${getInK(number: int.parse(widget.page['users_post'].toString()))}',
                          size: 14,
                          weight: FontWeight.w600,
                          color: Color(0xff212121),
                        ),
