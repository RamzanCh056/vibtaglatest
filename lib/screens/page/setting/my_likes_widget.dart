          ...
          children: [
            Column(
              children: [
                ...
                widget.page['page_likes'].toString() != '0'
                    ? ReusableText(
                        title:
                            '${getInK(number: int.parse(widget.page['page_likes'].toString()))} Members',
                        size: 14,
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          ReusableText(
                            title:
                                '${getInK(number: int.parse(widget.page['page_likes'].toString()))}',
                            size: 14,
                ...
                InkWell(
                  onTap: () async {
                    await AuthMethod().LikePage(widget.page['id'].toString());
                    setState(() {});
                  },
                  child: Container(
                    width: width,
                    ...
                    child: Text(
                      likes_data.contains(widget.page['id'].toString())
                          ? 'Liked'
                          : 'Like',
                      style: TextStyle(
                        fontSize: 16,
