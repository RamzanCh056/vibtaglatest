...
class PagePrivacySetting extends StatefulWidget {
  const PagePrivacySetting({Key? key}) : super(key: key);

  @override
  State<PagePrivacySetting> createState() => _PagePrivacySettingState();
}

class _PagePrivacySettingState extends State<PagePrivacySetting> {
